...
export default function TrendingCarousel({ rooms }: TrendingCarouselProps) {
  ...
  // The prev/next arrows, the slide dots, and the Join Room button are all
  // their own controls nested inside the now-clickable slide — each stops
  // the click from also bubbling up into the slide's own navigate-to-room
  // handler below.
